...
const connectMetamask = async () => {
  if(window.ethereum !== "undefined"){
      ...
      account = accounts[0];
      document.getElementById("accountArea").innerHTML = "Current Account Address: " + account;
  }
}
...
const Address = "0x99aBdeD799479Aa68B2cf3ff280AEf98926f1e68";
/*********************************************************************************************************************************/

window.web3 = await new Web3(window.ethereum);
window.contract = await new window.web3.eth.Contract(abi, Address); 
if (window.contract) {
  document.getElementById("contractArea").innerHTML = "Contract Address: " + Address;
